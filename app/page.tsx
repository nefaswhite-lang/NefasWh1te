...
export default function Page(){
  ...
  const CAN={mint:'/cans/can_mint.png',ice:'/cans/can_ice.png',citrus:'/cans/can_citrus.png',berry:'/cans/can_berry.png',apple:'/cans/can_apple.png',licorice:'/cans/can_licorice.png',ginger:'/cans/can_ginger.png',tea:'/cans/can_tea.png'} as const
  const PRODUCTS=[
    ...
    <div dir={dir} className="min-h-screen bg-gradient-to-b from-[#eaf4ff] to-white">
      ...
      <main className="mx-auto max-w-6xl px-4 py-10">
        ...
        <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {PRODUCTS.map((p,i)=>(
            <div key={i} className="rounded-2xl border border-blue-100 p-4 bg-white">
              <div className="h-40 grid place-content-center"><img src={CAN[p.cat as keyof typeof CAN]} className="h-36 mx-auto" alt="can"/></div>
...
function tr(lang:'ar'|'en'){ if(lang==='ar') return {h1:'نَفَس وايت — أبيض كلياً، صنع في النرويج', sub:'بوابة جملة للشرق الأوسط (AR/EN).', productsTitle:'المنتجات'}; return {h1:'Nefas White — All-White, Made in Norway', sub:'Wholesale gateway for MENA (AR/EN).', productsTitle:'Products'};}